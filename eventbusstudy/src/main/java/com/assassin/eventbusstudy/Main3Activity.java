...
*/
      ...
      final TextView  mDescTitleTextView = (TextView) findViewById(R.id.desc_title_textview);
     ...
     Button  mSignUpBtn = (Button) findViewById(R.id.sign_up_btn);
       ...
       TextView mSignInLayout = (TextView) findViewById(R.id.signin_layout);
        ...
        // top logo by left
        final ImageView  mLeftLogoImg = (ImageView) findViewById(R.id.left_logo_imageview);
        ...
        // top logo by right
        final ImageView   mRightLogoImg = (ImageView) findViewById(R.id.right_logo_imageview);
