package com.assassin.constraintlayout.widget;
...
public class SpringVerticalScrollView extends NestedScrollView {

    private float startDragY;
    private SpringAnimation springAnim;

    public SpringVerticalScrollView(Context context) {
        this(context, null);
    }

    public SpringVerticalScrollView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpringVerticalScrollView(Context context, @Nullable AttributeSet attrs, int defStyle) {
