package com.assassin.gsonstudy.utils.dialog;
...
public class DialogFragmentHelper {
    ...
    public static void showConfirmDialog(FragmentManager fragmentManager, final String message, final OnDialogResultListener<Integer> listener
